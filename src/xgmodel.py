...
file_path = "/Users/yanapathak/ds539/ds-bu-awards-analysis/data/cleaned_combined_awards.csv"
...
def create_feature_matrix(faculty_profiles, target_award):
    # feature matrix for predicting top candidates for an award
...
def train_xgboost_model(X, y):
    # Train XGBoost model with error handling for small datasets
...
def interactive_mode():
    # interactive mode to predict candidates for an award
